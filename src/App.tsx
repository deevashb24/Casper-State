...
function Flow() {
  ...
  const [log, setLog] = useState<LogEntry[]>([
    { t: now(), kind: 'info', text: 'Welcome to Casper State.' },
    {
      t: now(),
      kind: 'info',
  ...
  const onImportFile = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    reader.onload = () => {
      ...
      if (!parsed) {
        appendLog('Import failed — not a valid Casper State JSON file.', 'warn')
        return
      }
      const list = snapshotCurrent()
      const id = newId()
    ...
    <div className="flex h-screen w-full relative overflow-hidden bg-[#070708] text-slate-100 font-sans" style={{ ['--ui-scale' as string]: settings.scale }}>
      ...
      <div className="flex-1 relative flex flex-col">
        ...
        >
          ...
          >
            {settings.grid && <Background gap={24} color="rgba(255, 255, 255, 0.07)" />}
        ...
        <div className="confirm-overlay" onClick={() => setConfirmMainnet(false)}>
          <div className="confirm-modal" onClick={(e) => e.stopPropagation()}>
            ...
            <p className="confirm-text">
              You are about to switch Casper State to the <b>Casper Mainnet</b>. On mainnet,
