// Optional multi-provider AI "brain" for Casper State.
...
export async function editWorkflow(
  ...
  const system =
    'You edit an existing Casper State agent (a no-code automation on the Casper blockchain). ' +
...
export async function generateWorkflow(
  ...
  const system =
    'You are an assistant that designs automation workflows for Casper State, a no-code agent builder on the Casper blockchain. ' +
