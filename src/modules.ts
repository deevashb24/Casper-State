...
export const CATEGORY_LABELS: Record<ModuleCategory, string> = {
  trigger: 'Sensors & Triggers',
  logic: 'Logic Gates',
  agent: 'Autonomous AI',
  trading: 'DeFi Markets',
  payments: 'Value Routing',
  contracts: 'Smart Contracts',
  rwa: 'Tokenized RWA',
  output: 'Data Terminals',
}
...
export const MODULES: ModuleDef[] = [
  ...
  {
    type: 'swap',
    label: 'Liquidity Swap (CSPR.trade)',
    category: 'trading',
    icon: 'repeat',
    params: [
  ...
  {
    type: 'predict',
    label: 'Prediction Market (CSPR.guru)',
    category: 'trading',
    icon: 'sparkles',
    params: [
  ...
  {
    type: 'forcetransfer',
    label: 'Asset Recovery (Force Transfer)',
    category: 'rwa',
    icon: 'arrow-force',
    params: [
  ...
  {
    type: 'rwareport',
    label: 'Compliance Report Output',
    category: 'rwa',
    icon: 'report',
    params: [
      {
